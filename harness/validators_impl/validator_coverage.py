...
_VALIDATOR_TEST_CONTRACTS = {
    ...
    "runtime_progression_entry_contract": ValidatorTestContract(
        "runtime_progression_entry_contract",
        _TESTS_DIR / "test_runtime_progression_entry_contract.py",
        "RuntimeProgressionEntryContractValidator",
        (
            "missing_contract_file",
            "invalid_contract_json",
            "contract_schema_violation",
            ...
            "invalid_context_layout",
            "missing_transition_requirement",
            "missing_non_goal",
            "diagnostic_names_field",
        ),
    ),
    "runtime_progression_stages": ValidatorTestContract(
        "runtime_progression_stages",
        _TESTS_DIR / "test_runtime_progression_stages.py",
        "RuntimeProgressionStagesValidator",
        (
            "missing_contract_file",
            "invalid_contract_json",
            "contract_schema_violation",
    ...
    "stack_initialization_evidence": ValidatorTestContract(
        "stack_initialization_evidence",
        _TESTS_DIR / "test_stack_initialization_evidence.py",
        "StackInitializationEvidenceValidator",
        (
            "missing_marker",
            "marker_order_mismatch",
            "contract_mismatch",
            "missing_stack_pointer_setup",
            "missing_stack_use",
            "diagnostic_names_field",
        ),
    ),
    ...
    "memory_initialization_evidence": ValidatorTestContract(
        "memory_initialization_evidence",
        _TESTS_DIR / "test_memory_initialization_evidence.py",
        "MemoryInitializationEvidenceValidator",
        (
            "missing_region_symbol",
            "wrong_region_size",
            "wrong_region_alignment",
            "binary_region_mismatch",
            "partial_zero_fill",
            "probe_out_of_bounds",
            "wrong_probe_width",
            "missing_readback_comparison",
            "missing_restore",
            "marker_before_probe",
            "missing_marker",
            "halt_before_marker",
            "fallthrough_after_marker",
            "qemu_evidence_mismatch",
            "diagnostic_names_field",
        ),
    ),
    "controlled_runtime_loop_contract": ValidatorTestContract(
        "controlled_runtime_loop_contract",
        _TESTS_DIR / "test_controlled_runtime_loop_contract.py",
        ...
        (
            ...
            "contract_schema_violation",
            "wrong_stage_status",
            "wrong_iteration_limit",
            "missing_backward_edge_requirement",
            "invalid_state_definition",
            "wrong_marker_order",
            "invalid_status_map",
            "fallthrough_allowed",
            "missing_transition_owner",
            "missing_non_goal",
            "diagnostic_names_field",
        ),
    ),
    "controlled_runtime_loop_evidence": ValidatorTestContract(
        "controlled_runtime_loop_evidence",
        _TESTS_DIR / "test_controlled_runtime_loop_evidence.py",
        "ControlledRuntimeLoopEvidenceValidator",
        (
            "loop_entry_mismatch",
            "volatile_state_missing",
            "loop_sequence_mismatch",
            "loop_completion_mismatch",
            ...
            "runtime_loop_evidence_missing",
            "metadata_log_mismatch",
            "diagnostic_names_field",
        ),
    ),
    "first_governed_runtime_capability": ValidatorTestContract(
        "first_governed_runtime_capability",
        _TESTS_DIR / "test_first_governed_runtime_capability.py",
        ...
        (
            ...
            "invalid_request_geometry",
            "invalid_response_geometry",
            "invalid_proven_state",
    ...
    "first_governed_runtime_capability_evidence": ValidatorTestContract(
        "first_governed_runtime_capability_evidence",
        _TESTS_DIR / "test_first_governed_runtime_capability_evidence.py",
        ...
        (
            ...
            "response_population_missing",
            "response_validation_missing",
            "success_marker_before_validation",
            "success_marker_duplicated",
            "marker_bridge_missing",
    ...
    "runtime_state_transition_capability": ValidatorTestContract(
        "runtime_state_transition_capability",
        _TESTS_DIR / "test_runtime_state_transition_capability.py",
    ...
    "runtime_state_transition_capability_evidence": ValidatorTestContract(
        "runtime_state_transition_capability_evidence",
        _TESTS_DIR / "test_runtime_state_transition_capability_evidence.py",
        "RuntimeStateTransitionCapabilityEvidenceValidator",
        (
            "capability_path_missing",
            "source_layout_mismatch",
            "state_initialization_missing",
            "request_validation_missing",
            "dispatcher_sequence_mismatch",
            "generic_marker_duplicated",
            "mutation_sequence_mismatch",
            "volatile_access_missing",
            "response_validation_missing",
            "coordinator_sequence_mismatch",
    ...
    "cpu_extended_state_initialization_contract": ValidatorTestContract(
        "cpu_extended_state_initialization_contract",
        _TESTS_DIR / "test_cpu_extended_state_initialization_contract.py",
    ...
    "fixed_user_mapping_foundation": ValidatorTestContract(
        "fixed_user_mapping_foundation",
        _TESTS_DIR / "test_fixed_user_mapping_foundation.py",
        ...
        (
            ...
            "kernel_user_accessible",
            "write_execute_violation",
            "noncanonical_virtual_address",
            "misaligned_backing",
            "overlapping_user_regions",
            "invalid_user_permissions",
            "missing_user_propagation",
            "missing_wx_rule",
            "invalid_activation_policy",
            "missing_software_walk",
            "missing_survival_requirement",
            "invalid_marker_order",
            "missing_non_goal",
            "diagnostic_names_field",
        ),
    ),
    "fixed_user_mapping_foundation_evidence": ValidatorTestContract(
        "fixed_user_mapping_foundation_evidence",
        _TESTS_DIR / "test_fixed_user_mapping_foundation_evidence.py",
        "FixedUserMappingFoundationEvidenceValidator",
        (
            "mapping_sequence_invalid",
            "page_tables_not_zeroed",
            "missing_upper_level_user",
            "nx_policy_missing",
            "cr3_readback_missing",
            "software_walk_invalid",
            "survival_probe_invalid",
            "privilege_transition_present",
            "linker_geometry_invalid",
            "missing_elf_symbol",
    ...
    "bounded_privilege_transition_probe_contract": ValidatorTestContract(
        "bounded_privilege_transition_probe_contract",
        _TESTS_DIR / "test_bounded_privilege_transition_probe_contract.py",
        "BoundedPrivilegeTransitionProbeContractValidator",
        (
            "missing_contract_file",
            "invalid_contract_json",
            "contract_schema_violation",
            "invalid_transition_mechanism",
            "invalid_selector",
            "invalid_gdt_geometry",
            "invalid_tss_geometry",
            "invalid_tss_rsp0",
            "invalid_return_gate",
            "invalid_stack_geometry",
            "invalid_stack_permissions",
            "invalid_user_rsp",
            "invalid_user_rip",
            "missing_cpl_validation",
            "invalid_rflags_policy",
            "invalid_user_code_permissions",
            "invalid_probe_width",
            "missing_probe_requirement",
            "invalid_return_boundary",
    ...
    "bounded_privilege_transition_probe_evidence": ValidatorTestContract(
        "bounded_privilege_transition_probe_evidence",
        _TESTS_DIR / "test_bounded_privilege_transition_probe_evidence.py",
        "BoundedPrivilegeTransitionProbeEvidenceValidator",
        (
            "transition_sequence_invalid",
            "descriptor_setup_invalid",
            "entry_frame_invalid",
            "entry_geometry_invalid",
            "user_probe_invalid",
            "ring3_serial_io_present",
            "return_validation_invalid",
            "fault_halt_missing",
            "interrupts_enabled",
            "linker_geometry_invalid",
            "missing_elf_symbol",
            "elf_geometry_invalid",
            "missing_elf_evidence",
            "prohibited_instruction_present",
    ...
    "fixed_user_request_boundary_contract": ValidatorTestContract(
        "fixed_user_request_boundary_contract",
        _TESTS_DIR / "test_fixed_user_request_boundary_contract.py",
        ...
        (
            ...
            "invalid_response_geometry",
            "invalid_user_span",
            "invalid_shadow_geometry",
            "invalid_shadow_policy",
            "invalid_service_identity",
            "invalid_response_token_rule",
            "service_crosses_copy_boundary",
            "missing_copy_requirement",
            "caller_controlled_copy",
            "invalid_copy_size",
            "invalid_page_policy",
            "missing_buffer_clear",
            "missing_buffer_clear_readback",
            "invalid_clear_size",
            "invalid_marker_order",
            "invalid_marker_ownership",
            "invalid_failure_status",
            "invalid_halt_behavior",
            "missing_non_goal",
            "claim_boundary_too_broad",
            "diagnostic_names_field",
        ),
    ),
    "fixed_user_request_boundary_evidence": ValidatorTestContract(
        "fixed_user_request_boundary_evidence",
        _TESTS_DIR / "test_fixed_user_request_boundary_evidence.py",
        "FixedUserRequestBoundaryEvidenceValidator",
        (
            "layout_geometry_invalid",
            "ring3_request_invalid",
            "handler_order_invalid",
            "span_validation_invalid",
            "copy_in_invalid",
            "copy_out_invalid",
            "response_readback_invalid",
            "request_validation_invalid",
            "service_invalid",
            "buffer_clear_invalid",
            "failure_emits_success",
            "failure_halt_missing",
            "linker_geometry_invalid",
            "missing_elf_symbol",
            "elf_geometry_invalid",
            "missing_elf_evidence",
            "missing_elf_copy_evidence",
            "missing_elf_clear_evidence",
            "prohibited_instruction_present",
            "runtime_outcome_invalid",
            "metadata_log_mismatch",
            "runtime_marker_missing",
    ...
    "bounded_user_response_consumption_contract": ValidatorTestContract(
        "bounded_user_response_consumption_contract",
        _TESTS_DIR / "test_bounded_user_response_consumption_contract.py",
        ...
        (
            ...
            "invalid_response_consumer",
            "invalid_response_geometry",
            "invalid_record_geometry",
            "record_overlap",
            "invalid_shadow_geometry",
            "invalid_shadow_policy",
            "missing_ring3_response_check",
            "missing_second_frame_validation",
            "missing_response_revalidation",
            "invalid_record_copy",
            "missing_clearing_policy",
            "missing_phase_reset",
            "invalid_marker_order",
            "invalid_marker_ownership",
            "invalid_failure_status",
    ...
    "bounded_user_response_consumption_evidence": ValidatorTestContract(
        "bounded_user_response_consumption_evidence",
        _TESTS_DIR / "test_bounded_user_response_consumption_evidence.py",
        "BoundedUserResponseConsumptionEvidenceValidator",
        (
            "layout_geometry_invalid",
            "phase_dispatch_invalid",
            "first_handler_order_invalid",
            "resume_frame_invalid",
            "ring3_consumer_invalid",
            "partial_ring3_response_validation",
            "second_handler_order_invalid",
            "record_copy_invalid",
            "record_validation_invalid",
            "final_clearing_invalid",
            "phase_reset_invalid",
            "failure_emits_success",
            "linker_geometry_invalid",
            "missing_elf_symbol",
    ...
    "fixed_user_runtime_status_service_contract": ValidatorTestContract(
        "fixed_user_runtime_status_service_contract",
        _TESTS_DIR / "test_fixed_user_runtime_status_service_contract.py",
        ...
        (
            ...
            "snapshot_geometry_invalid",
            "snapshot_values_invalid",
            "request_identity_invalid",
            "response_geometry_invalid",
            "feature_mask_invalid",
            "ring3_validation_invalid",
            "ring0_revalidation_invalid",
            "cleanup_invalid",
    ...
    "fixed_user_runtime_status_service_evidence": ValidatorTestContract(
        "fixed_user_runtime_status_service_evidence",
        _TESTS_DIR / "test_fixed_user_runtime_status_service_evidence.py",
        "FixedUserRuntimeStatusServiceEvidenceValidator",
        (
            "boot_executes_transaction",
            "boot_preparation_invalid",
            "runtime_order_invalid",
            "shared_status_missing",
            "pre_runtime_status_substitute",
            "internal_status_source_diverged",
            "bridge_order_invalid",
            "odin_return_invalid",
            "response_geometry_invalid",
            "service_order_invalid",
            "partial_ring3_validation",
            "response_digest_invalid",
            "capability_after_failed_transaction",
            "failure_emits_success",
            "missing_elf_evidence",
            "missing_elf_symbol",
            "snapshot_elf_geometry_invalid",
            "elf_call_order_invalid",
            "elf_response_stores_missing",
    ...
    "runtime_progression_evidence": ValidatorTestContract(
        "runtime_progression_evidence",
        _TESTS_DIR / "test_runtime_progression_evidence.py",
        "RuntimeProgressionEvidenceValidator",
        (
            "missing_entry_symbol",
            "wrong_entry_signature",
            "wrong_calling_convention",
            "misaligned_call_site_stack",
            "missing_context_version",
            "invalid_context_field_order",
    ...
    "qemu_smoke_evidence": ValidatorTestContract(
        ...
        (
            ...
            "summary_missing_blocker",
            "summary_missing_expected_marker",
