...
def _expected_blocker_from_logs(metadata: dict[str, object]) -> str | None:
    ...
    if _EARLY_MARKERS[3] in observed and _EARLY_MARKERS[4] not in observed:
    ...
    if _EARLY_MARKERS[16] in observed and _EARLY_MARKERS[19] not in observed:
