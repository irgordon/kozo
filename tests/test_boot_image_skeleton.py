...
def write_fixture_files(root: Path) -> dict[str, Path]:
    ...
    paths["boot_doc"].write_text("Remaining blocker: `missing_qemu_execution_evidence`.\n")
    paths["blockers"].write_text("The remaining blocker is `missing_qemu_execution_evidence`.\n")
...
def valid_report() -> dict[str, object]:
    return {
        ...
        "missing_components": ["QEMU smoke execution"],
    }
