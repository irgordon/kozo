...
Open [KOZO v1.1.0](https://github.com/irgordon/kozo/releases/tag/v1.1.0).
...
```bash
release_iso="$(cd kozo-v1.1.0 && pwd)/kozo.iso"
env \
...
Success prints `VERIFY: PASS`. The v1.1.0 release gate expects 67 checks, no
failures, QEMU outcome `pass`, and 52 ordered runtime markers.
...
[v1.1.0 release notes](../releases/v1.1.0.md) for the artifact list and limits.
...
no blocker, 52 ordered markers, and final marker
